...
const ChatBar: React.FC = () => {
  ...
  return (
    <>
      {/* Backdrop rendered via Portal at <body> level — NOT inside chat-wrapper.
          This prevents the stacking context of chat-wrapper from breaking
          backdrop-filter in Chrome production builds. */}
